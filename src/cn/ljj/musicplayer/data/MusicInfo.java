...
public class MusicInfo implements Parcelable {
    ...
    public String toString() {
        return "MusicInfo [name=" + mName + ", artist=" + mArtist + ", album=" + mAlbum
                + ", musicPath=" + mMusicPath + ", lrcPath=" + mLrcPath + ", picPath=" + mPicPath
                + ", duration=" + mDuration + ", _id=" + _id + ", mSongId=" + mSongId
                + ", mAllArtistId=" + mAllArtistId + ", mAlbumId=" + mAlbumId + ", mLrcLink="
                + mLrcLink + ", mAllRate=" + mAllRate + ", mCharge=" + mCharge + ", mResourceType="
                + mResourceType + ", mHavehigh=" + mHavehigh + ", mCopyType=" + mCopyType
                + ", mRelateStatus=" + mRelateStatus + ", mHasMV=" + mHasMV + ", mSongPicSmall="
                + mSongPicSmall + ", mSongPicBig=" + mSongPicBig + ", mSongPicRadio="
                + mSongPicRadio + ", mFormat=" + mFormat + ", mRate=" + mRate + ", mSize=" + mSize
                + ", mAppendix=" + mAppendix + ", mContent=" + mContent + "]";
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((mLrcPath == null) ? 0 : mLrcPath.hashCode());
        result = prime * result + ((mMusicPath == null) ? 0 : mMusicPath.hashCode());
        result = prime * result + ((mName == null) ? 0 : mName.hashCode());
        result = prime * result + ((mPicPath == null) ? 0 : mPicPath.hashCode());
        return result;
    }
